...
export const UseEffect = ()=>{
    ...
    const url_currencies_codes = ()=> `https://api.coingecko.com/api/v3/simple/supported_vs_currencies`
    const url_currencies_list = ()=> `https://api.coingecko.com/api/v3/coins/list`
    ...
    useEffect(() => {
     ...
     const getPriceApi = async()=>{
          try { 
            ...
            catch(e){setError([true, 'No se pudo obtener la criptomonea solicitada.'])}
        ...
        :
            <div className={evenStyle} >
                ...
                <div className="btn-group">
                    <button className="btn btn-warning" onClick={()=>btnHandleClick('bitcoin')}>Bitcoin </button>
                    <button className="btn btn-primary" onClick={()=>btnHandleClick('ethereum')}>Ethereum </button>
