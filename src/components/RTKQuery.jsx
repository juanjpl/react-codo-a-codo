...
export const Loading = ({loading}) => {
  return (
    <>
    {
        ...
        :
        <div className='text-bg-warning rounded py-1 my-4 shadow'>Cargado</div>
    }
    </>
  )
}
...
export const Post = ({post , next , prev}) => {
  ...
  return (
    <div className='bg-light rounded shadow p-3' >
        <div>
            ...
            <div className='d-glex gap-2 mt-3 justify-content-center'>
                <button className={css} onClick={prev}>
                    Anterior
                </button>
                <button className={css} onClick={next}>
                    Siguiente
                </button>
                </div>  
    </div>
