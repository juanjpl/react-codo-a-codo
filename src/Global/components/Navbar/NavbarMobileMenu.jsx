...
export const renderMobileMenu =(mobileMoreAnchorEl, handleProfileMenuOpen,handleMobileMenuClose,isMobileMenuOpen)=>{
    ...
    return(
      ...
      >
        <MenuItem>
        <IconButton size="large" aria-label="show quantity products" color="inherit">
